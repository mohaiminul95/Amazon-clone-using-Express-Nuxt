...
<script>
    export default {
        async asyncData({ $axios, params }) {
            try{
                let countriesResponse = $axios.$get("countries");
                let addressResponse = $axios.$get(`addresses/${params.id}`);
        ...
        methods: {
            async onUpdateAddress() {
                try{
                    ...
                    let response = await this.$axios.$put(`addresses/${this.$route.params.id}`, data);
                    if(response.success)
                    {
